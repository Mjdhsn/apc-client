...
import css from "./Collation.module.scss";
import { useStore } from "../../store/store";
import ComboBox from "../ComboBox/ComboBox";
import SearchIcon from "@mui/icons-material/Search";
import Loader from "../Loader/Loader";

const CollationSearch = (props) => {
  ...
  const user_type = Number(localStorage.getItem("user_type"));
  const user_place = "An,array,in,a,string,separated,by,a,comma";
...
export default CollationSearch;
