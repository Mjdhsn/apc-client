...
const Index = () => {
  ...
  const { data, isLoading, menuSelected, isFetching } = useExpectedResult(location.state, "repanalysis_polling_tab3")

  return (
    <div className={css.container}>

        {/* head */}
        <h3> REP Winner Prediction ({ location.state.child })</h3>
