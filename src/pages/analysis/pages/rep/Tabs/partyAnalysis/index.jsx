...
import { useRepPartyAnalysis } from '../../../../../../hooks/usePartyAnalysis'
...
const Index = () => {
  ...
  const { routeLevel, selectedLevel, setSelectedLevel, setApiLevel, apiLevel, searchFields, setSearchFields, searchLevel, parties, setParty, getPartyAnalysis, data, isLoading } = useRepPartyAnalysis(location)
