...
const Index = () => {
  ...
  const { data, isLoading, menuSelected, isFetching } = useExpectedResult(location.state, "senateanalysis_polling_tab3")

  return (
    <div className={css.container}>

        {/* head */}
        <h3> Senate Winner Prediction ({ location.state.child })</h3>
