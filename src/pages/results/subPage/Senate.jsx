...
import { useSenateResult } from "../../../hooks/useResult";
...
import { SenateSelectBoxes } from "../../../shared/SelectBoxes/SelectBoxes";


const Senate = () => {
  const location = useLocation();
  const { selectedLevel, setSelectedLevel, searchFields, setSearchFields, searchLevel, routeLevel, menuSelected, parties, partyHandlers, getResults, results, isResultLoading } = useSenateResult(location);
  ...
  return (
    <>
      ...
      <div className={css.container}>
        ...
        <SenateSelectBoxes searchFields={searchFields} setSearchFields={setSearchFields} parties={parties} searchLevel={searchLevel} getResults={getResults} count={4} />
