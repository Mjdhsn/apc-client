...
// ----- PRESIDENTIAL ------
export const PresidentialSelectBoxes = ({ searchFields, setSearchFields, searchLevel, parties, isParite, getResults }) => {
...
// ----- SENATE ------
export const SenateSelectBoxes = ({ searchFields, setSearchFields, searchLevel, parties, isParite, getResults, count }) => {
